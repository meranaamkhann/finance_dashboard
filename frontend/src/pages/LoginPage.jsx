...
export default function LoginPage() {
  ...
  const fillCreds = (u,p) => setForm({ username:u, password:p })
        ...
        <div className="card p-7">
          ...
          <div className="mt-5 pt-4 border-t border-surface-border">
            ...
            {[['admin','Admin@1234','ADMIN'],['analyst','Analyst@1234','ANALYST'],['viewer','Viewer@1234','VIEWER']].map(([u,p,r])=>(
              <button key={u} onClick={()=>fillCreds(u,p)}
                className="flex items-center justify-between w-full px-3 py-1.5 rounded-lg hover:bg-slate-50 transition-colors mb-1">
