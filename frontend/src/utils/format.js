...
export const EXPENSE_CATS = ['FOOD','RENT','UTILITIES','TRANSPORT','HEALTHCARE','EDUCATION',
  'ENTERTAINMENT','SHOPPING','TRAVEL','INSURANCE','SAVINGS','EMI','SUBSCRIPTION','PERSONAL_CARE','HOME','OTHER_EXPENSE']
export const INCOME_CATS  = ['SALARY','FREELANCE','INVESTMENT','RENTAL','BUSINESS','BONUS','GIFT','OTHER_INCOME']
